...
#import "numberexam5.h"


@implementation numberexam5
...
- (void)viewDidLoad {
	...
	NSString *path7 = [[NSBundle mainBundle] pathForResource:@"result5" ofType:@"mp3"];
	...
	NSString *path13 = [[NSBundle mainBundle] pathForResource:@"right5" ofType:@"mp3"];
...
- (IBAction)nextpage:(id)sender{
	...
	[pressnumber stop];
	numberexam6 *nextexam = [[numberexam6 alloc] init];
