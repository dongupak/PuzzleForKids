...
#import "numberexam3.h"


@implementation numberexam3
...
- (void)viewDidLoad {
	...
	NSString *path5 = [[NSBundle mainBundle] pathForResource:@"result3" ofType:@"mp3"];
	...
	NSString *path13 = [[NSBundle mainBundle] pathForResource:@"right3" ofType:@"mp3"];
...
- (IBAction)nextpage:(id)sender{
	[pressnumber stop];
	numberexam4 *nextexam = [[numberexam4 alloc] init];
