...
#import "numberexam7.h"


@implementation numberexam7
...
- (void)viewDidLoad {
	...
	NSString *path9 = [[NSBundle mainBundle] pathForResource:@"result7" ofType:@"mp3"];
	...
	NSString *path13 = [[NSBundle mainBundle] pathForResource:@"right7" ofType:@"mp3"];
...
- (IBAction)nextpage:(id)sender{
	[pressnumber stop];
	numberexam8 *nextexam = [[numberexam8 alloc] init];
