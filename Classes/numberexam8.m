...
#import "numberexam8.h"


@implementation numberexam8
...
- (void)viewDidLoad {
	...
	NSString *path10 = [[NSBundle mainBundle] pathForResource:@"result8" ofType:@"mp3"];
	...
	NSString *path13 = [[NSBundle mainBundle] pathForResource:@"right8" ofType:@"mp3"];
...
- (IBAction)nextpage:(id)sender{
	[pressnumber stop];
	numberexam9 *nextexam = [[numberexam9 alloc] init];
