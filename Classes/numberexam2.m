...
- (void)viewDidLoad {
	...
	NSString *path4 = [[NSBundle mainBundle] pathForResource:@"result2" ofType:@"mp3"];
	...
	NSString *path13 = [[NSBundle mainBundle] pathForResource:@"right2" ofType:@"mp3"];
...
- (IBAction)nextpage:(id)sender{
	[pressnumber stop];
	numberexam3 *nextexam = [[numberexam3 alloc] init];
