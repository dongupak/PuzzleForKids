...
- (void)viewDidLoad {
	...
	NSString *path8 = [[NSBundle mainBundle] pathForResource:@"result6" ofType:@"mp3"];
	...
	NSString *path13 = [[NSBundle mainBundle] pathForResource:@"right6" ofType:@"mp3"];
...
- (IBAction)nextpage:(id)sender{
	[pressnumber stop];
	numberexam7 *nextexam = [[numberexam7 alloc] init];
