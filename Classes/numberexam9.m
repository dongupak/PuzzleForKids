...
#import "numberexam9.h"


@implementation numberexam9
...
- (void)viewDidLoad {
	...
	NSString *path11 = [[NSBundle mainBundle] pathForResource:@"result9" ofType:@"mp3"];
	...
	NSString *path13 = [[NSBundle mainBundle] pathForResource:@"right9" ofType:@"mp3"];
...
- (IBAction)nextpage:(id)sender{
	[pressnumber stop];
	numberexam10 *nextexam = [[numberexam10 alloc] init];
